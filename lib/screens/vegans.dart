...
class Vegans extends StatefulWidget {
  const Vegans({super.key});

  @override
  State<Vegans> createState() => _VegansState();
}

class _VegansState extends State<Vegans> {
